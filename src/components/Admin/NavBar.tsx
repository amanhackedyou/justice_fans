...
import { useSideBarContext } from '@/context/Admin/SideBarContext'
...
const NavBar = ({ title = "Admin", isShowing = true, hasBackButton = false, actions = [] }: { title?: string, hasBackButton?: boolean, actions?: NavBarActions[], isShowing?: boolean }) => {
